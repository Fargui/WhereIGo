 ...
 */
final class Version20200421151215 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE calendar_has_place CHANGE place_id place_id INT NOT NULL');
        $this->addSql('ALTER TABLE category CHANGE icon icon VARCHAR(255) DEFAULT NULL');
        $this->addSql('ALTER TABLE place_has_category CHANGE category_id category_id INT NOT NULL, CHANGE place_id place_id INT NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE calendar_has_place CHANGE place_id place_id INT DEFAULT NULL');
